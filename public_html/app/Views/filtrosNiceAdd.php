    ...
    <div class="container">
        <div class="row">
            <div class="col">
                ...
                <form id="formCadastro" method="post" action="<?=base_url('filtrosNice/store')?>">

                    <div class="mb-3">
                        <label for="especificacao" class="form-label">Especificação:*</label>
                        <input type="text" class="form-control" id="especificacao" name="especificacao" aria-describedby="especificacaoHelp" required />
                        <div id="especificacaoHelp" class="form-text">Insira aqui o texto da especificação a ser filtrada.</div>
                    </div>

                    <div class="mb-3">
                        <label for="classe" class="form-label">Classe:</label>
                        <input type="text" class="form-control" id="classe" name="classe" aria-describedby="classeHelp" />
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="num_base" name="num_base" aria-describedby="num_baseHelp">
